...
const Payment = ({ cc, type, id, isPreferred, shouldShowCheckmark, updatePreferredPayment, isPaymentMethodBeingUpdated }) => (
  <li className={isPaymentMethodBeingUpdated ? paymentItemActive : paymentItem} onClick={() => updatePreferredPayment(id)} style={{height:isPreferred && '6em'}}>
    ...
    { shouldShowCheckmark && <span className={checkmarkContainer} style={{opacity:isPreferred && 1}}><Checkmark /></span> }
  </li>
)
